...
public class IPTU extends JFrame {
	...
	private boolean getVerificaTxtVazio() {
		try {
			...
			JOptionPane.showMessageDialog(null, "área não informada", "Erro:",
	...
	/*
	 * normal = 1.10; esquina = 0.20 comercial = 0.10 limpo = 15%
	 */
	...
	private void setCalcular() {
		...
		if (getVerificaTxtVazio()) {
			...
			if (chbLimpo.isSelected()) {
				// System.out.println("checkbox selecionado vlr" + (soma *
				// (15d/100d)));
				soma += -(soma * (15 / 100d));
			}
			BigDecimal valorNovo = new BigDecimal(soma);
			txtValor.setText("R$ "
					+ valorNovo.setScale(2, BigDecimal.ROUND_HALF_UP));
		}
	}
